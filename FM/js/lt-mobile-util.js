...
CanvasRenderingContext2D.prototype.drawDetail = function (color) {//通过canvas生成详细图标。
    var context = this;
    context.strokeStyle = color || "#000";
    for (var i = 0; i < 3; i++) {
        context.moveTo(5, 10 + i * 7);
        context.lineTo(8, 10 + i * 7);
        context.stroke();
        context.moveTo(15, 10 + i * 7);
        context.lineTo(31, 10 + i * 7);
        context.stroke();
    }
}
